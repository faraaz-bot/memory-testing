...
\begin{frame}
    ...
    \item Use statistical tests to try and handle noise.
    \end{itemize}
...
\begin{frame}
    \frametitle{What is our experimental design?}
...
\begin{frame}
    \frametitle{Separated experimental design}
...
\begin{frame}
    ...
    \item Load two versions of the implementation into the same executable
      ...
      \item Libraries must not depend on other shared libraries: \texttt{-DSINGLELIB}
      \end{itemize}
...
\begin{frame}
  ...
  To make the noise identical, we must de-correlate test case with time.
...
\begin{frame}
    ...
    TODO: talk about noise an experiment correlation.  Go through the
    various stages and show how the data behaves better and better.
...
\begin{frame}
    ...
    FIXME: we need to randomize and stuff, yo.  C'mon.

    Visualizing the data is helpful in trying to understand it.
