...
\begin{frame}
  ...
  \begin{center}
    \begin{minipage}[b][45mm][t]{80mm}
      Jitter, the random variation of exeuction time on compute
...
\begin{frame}
  \frametitle{Problem}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{pdf/timeseries.pdf}
  \end{center}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Randomly select a time foreach case.
...
\begin{frame}
  ...
  Other intersting statistical tests:
  \bigskip
  \begin{itemize}
...
\begin{frame}
   ...
   We look at the false-postivie rate on a variety of platforms.
...
\begin{frame}
  ...
  \item Different devices have diffferent FPRs:
    \begin{itemize}
...
\begin{frame}
  ...
  The data should look piecewise constant - discontinuties imply performance changes.
...
\begin{frame}
  ...
  \item A stastical test gives us a new $p$
  \item Combine $p_0$ and $p$ to give us a new probability $p'$.
  \end{itemize}

  \bigskip
  Some sofrt of Bayesian algorithm prediction.
