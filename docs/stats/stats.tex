...
\begin{frame}
   ...
   % ~/sync/amd/ntrial/ntrials_test.py -B -s sep -b ~/sync/amd/ntrial/ixt-hq-107 -o ~/repo/rocfft-misc/docs/stats/data/ixt_hq_107_sep.dat
   % ~/sync/amd/ntrial/ntrials_test.py -B -s seq -b ~/sync/amd/ntrial/ixt-hq-107 -o ~/repo/rocfft-misc/docs/stats/data/ixt_hq_107_seq.dat
   % ~/sync/amd/ntrial/ntrials_test.py -B -s alt -b ~/sync/amd/ntrial/ixt-hq-107 -o ~/repo/rocfft-misc/docs/stats/data/ixt_hq_107_alt.dat
   % ~/sync/amd/ntrial/ntrials_test.py -B -s ran -b ~/sync/amd/ntrial/ixt-hq-107 -o ~/repo/rocfft-misc/docs/stats/data/ixt_hq_107_ran.dat
...
\begin{frame}
   ...
   % ~/sync/amd/ntrial/ntrials_test.py -B -s sep -b ~/sync/amd/ntrial/x1000c0s6b0n0 -o ~/repo/rocfft-misc/docs/stats/data/x1000c0s6b0n0_sep.dat
   % ~/sync/amd/ntrial/ntrials_test.py -B -s seq -b ~/sync/amd/ntrial/x1000c0s6b0n0 -o ~/repo/rocfft-misc/docs/stats/data/x1000c0s6b0n0_seq.dat
   % ~/sync/amd/ntrial/ntrials_test.py -B -s alt -b ~/sync/amd/ntrial/x1000c0s6b0n0 -o ~/repo/rocfft-misc/docs/stats/data/x1000c0s6b0n0_alt.dat
   % ~/sync/amd/ntrial/ntrials_test.py -B -s ran -b ~/sync/amd/ntrial/x1000c0s6b0n0 -o ~/repo/rocfft-misc/docs/stats/data/x1000c0s6b0n0_ran.dat
...
\begin{frame}
  \frametitle{Statistical tests: Lockhart MI250X A1}
   ...
   % ~/sync/amd/ntrial/ntrials_test.py -B -s sep -b ~/sync/amd/ntrial/x1000c0s5b0n0 -o ~/repo/rocfft-misc/docs/stats/data/x1000c0s5b0n0_sep.dat
   % ~/sync/amd/ntrial/ntrials_test.py -B -s seq -b ~/sync/amd/ntrial/x1000c0s5b0n0 -o ~/repo/rocfft-misc/docs/stats/data/x1000c0s5b0n0_seq.dat
   % ~/sync/amd/ntrial/ntrials_test.py -B -s alt -b ~/sync/amd/ntrial/x1000c0s5b0n0 -o ~/repo/rocfft-misc/docs/stats/data/x1000c0s5b0n0_alt.dat
   % ~/sync/amd/ntrial/ntrials_test.py -B -s ran -b ~/sync/amd/ntrial/x1000c0s5b0n0 -o ~/repo/rocfft-misc/docs/stats/data/x1000c0s5b0n0_ran.dat
...
\begin{frame}
  \frametitle{Statistical tests: More more more}

    FIXME: more devices, more and also look at different statistical tests.
...
\begin{frame}
  ...
  FIXME: show that we can also detect changes.
