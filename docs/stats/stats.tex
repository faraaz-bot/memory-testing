...
\begin{frame}
  ...
  FFTs are bandwidth-limited.  What about compute-bound?
...
\begin{frame}
  ...
  Re-visit CPUs: if we dive in, what results to we get?

  \bigskip

  Multi-device: when we go off-device, what kind of noise profile do we get?
...
\begin{frame}
  ...
  FIXME
    ...
    Ref: papers dealing with jitter in collective communication.
