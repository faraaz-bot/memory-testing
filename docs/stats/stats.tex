...
\begin{frame}
  ...
  \begin{center}
    Always use a \textcolor{red}{red} pen to colour your data.
  \end{center}

  \begin{itemize}
  \item \textcolor{red}{Red}-labelled data has lower execution time.
  \item Robust over three orders of magnitude of sample sizes.
  \item Appropriate AMD branding.
  \end{itemize}

  % NB: CPU data was on an intel machine, so the red-labelling solution doesn't apply.
...
\begin{frame}
    ...
    Show: As we increase the number of histogram bins, things get
    quantized.
