...
~/sync/amd/ntrial/ntrials_test.py -m moods  -B -s sep -b ~/sync/amd/ntrial/cgy-alakazam -o ~/repo/rocfft-misc/docs/stats/data/cgy-alakazam_sep.dat
~/sync/amd/ntrial/ntrials_test.py -m moods  -B -s seq -b ~/sync/amd/ntrial/cgy-alakazam -o ~/repo/rocfft-misc/docs/stats/data/cgy-alakazam_seq.dat
~/sync/amd/ntrial/ntrials_test.py -m moods  -B -s alt -b ~/sync/amd/ntrial/cgy-alakazam -o ~/repo/rocfft-misc/docs/stats/data/cgy-alakazam_alt.dat
~/sync/amd/ntrial/ntrials_test.py -m moods  -B -s ran -b ~/sync/amd/ntrial/cgy-alakazam -o ~/repo/rocfft-misc/docs/stats/data/cgy-alakazam_ran.dat
