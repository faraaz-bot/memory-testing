...
Idea here is that we can reduce this to the 2D case.  For example, in
3D, the first dimension is paired off with the last two dimensions,
...
Application: check test and intermediary data structures input,
generate random points in parameter space, validate user input.

TODO: mention that this is a constrained linear diophantine equation,
and we're looking for the existence of non-unique solutions.
