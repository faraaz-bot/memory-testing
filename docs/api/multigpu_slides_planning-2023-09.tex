...
\begin{frame}
  ...
  \begin{itemize}
  \item Molecular Dynamcs (MD)
    \begin{itemize}
    \item eg: NAMD, Gromacs, LAMMPS
    \item Ewald sum for electostatic interacions
...
\begin{frame}
  ...
  \item cufftDx provides somewhat analygous functionality
    \begin{itemize}
    \item limited functionality
    \item dificult to use
    \end{itemize}
  \end{itemize}
...
\begin{frame}
  ...
  \item We can leverage lossless and lossey compression in the API
  \end{itemize}
...
\begin{frame}
  ...
  \item Further improvements:
    \begin{itemize}
    \item efficient buffer packing should be worht $\approx{}30\%$
...
\begin{frame}
  ...
  \item rocFFT performance is steadily improving
    \begin{itemize}
    \item 13$x$ improvement for targetted cases (baseline: ROCm 4.0)
    \end{itemize}
  \item \emph{MI200 offered no perfomance uplift for rocFFT}
...
\begin{frame}
  ...
  \item 6.0: feature-complete
    \begin{itemize}
    \item Single-proc complex-complex functional
    \end{itemize}
  \item 6.1
    \begin{itemize}
    \item Single-proc real/complex functional
    \item Improve test coverage for single-proc
    \item Improve performance for single-proc
    \end{itemize}
  \item 6.2
    \begin{itemize}
