...
\begin{frame}
  ...
  single/multi-process multi-gpu
...
\begin{frame}
  ...
  How to preview this to the world?
  
  If it isn't performant, it's not worthwhile

  Single-gpu speed is an issue

  MI200 has not been kind to rocFFT

  No productized rocSHMEM
...
\begin{frame}
  ...
  6.1: improve perf and test infra

  6.2: MPI functional

  6.3: MPI perf starting
