...
\end{verbatim}
3 transposes is already enough.  With fused kernels, this should be
...
Since LDS if 64KB\footnote{Wich ought to be enough for
...
There are no tickets for this feature.  Impact is unknown.
