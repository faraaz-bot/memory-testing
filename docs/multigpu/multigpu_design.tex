...
\href{heffte}{https://github.com/icl-utk-edu/heffte}
...
There are a number of enums for using library-provided data
distributions.
...
The reshape API seems to be usable separately from the cuFFTMp library
itself.
