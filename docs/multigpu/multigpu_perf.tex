...
The multi-device cuFFT libraries 
...
Initialization is either with nvshmem or an MPI comm.

cufftXtSetDistribution

The reshape API seems to be 

\subsection{heFFTe}

heFFTe has a C and a C++ interface.  Slab and pencil decomposition are
supported.
