...
We can resolve tihs issue by re-applying the Hermitian symmetry
...
method, and 17\% less for 3D problems.  Since smaller FFTs have better
cache behaviour, the memory efficiency may even be better in practice.
