...
y_n$.  Then, $Z_k = X_k + i Y_k$, and we can recover the invididual
transforms via
\begin{align}
...
format, uers expect $N_D$ to be chopped in half, and in a column-major
...
we woud fall back to less optimal algorithm, notably the
...
the data and taking the complex conjugate as approporiate, which
