...
\begin{frame}
  ...
  \begin{itemize}
  \item \url{https://github.com/ROCmSoftwarePlatform/rocFFT/tree/develop/clients/samples}
  \item \url{https://github.com/ROCmSoftwarePlatform/hipFFT/tree/master/clients/samples}
  \end{itemize}
