...
\section{2D Decompositions}

There are basically two decompositions for 2D data of size $N^2$ over
$P$ procs; either block or pencil.  Block decompositions have dimensions
\begin{dmath}
  \label{brick2d}
...
\subsection{2D transform summary}
...
\subsection{3D transform summary}
