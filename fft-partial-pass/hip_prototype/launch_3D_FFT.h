...
template <typename T>
void Get_SBRR_64_Args_PP(const std::vector<size_t> &length,
                         const std::vector<size_t> &inStride,
                         const std::vector<size_t> &outStride,
                         const size_t &iDist,
                         const size_t &oDist,
...
template <typename T>
void Get_SBCC_64_Args_PP(const std::vector<size_t> &length,
                         const std::vector<size_t> &inStride,
                         const std::vector<size_t> &outStride,
                         const size_t &iDist,
                         const size_t &oDist,
                                  ...
                                  gpubuf_t<T> &obuf)
{
    ...
    hipLaunchKernelGGL(fft_rtc_fwd_len64_factors_8_8_wgs_128_tpt_8_dim3_dp_ip_CI_unitstride_sbrr_pp,
                       dim3(gridParam.b_x),
                       dim3(gridParam.wgs_x),
                       gridParam.lds_bytes,
                       0,
...
template <typename T>
inline void Launch_3D_FFT(const std::vector<size_t> &length,
...
template <typename T>
inline void Launch_3D_FFT_PP(const std::vector<size_t> &length,
