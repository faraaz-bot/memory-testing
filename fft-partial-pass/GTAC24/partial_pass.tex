...
\begin{figure*}[h]  
  ...
  \subfloat[$\mkern-90mu$]{\label{subfig:single_precision_time} \includegraphics[width=0.43\textwidth]{singletime.pdf}}
  \subfloat[$\mkern-90mu$]{\label{subfig:double_precision_time} \includegraphics[width=0.43\textwidth]{doubletime.pdf}}
...
partial-pass algorithm on MI100 runs as fast as the default algorithm
on MI250X. On double-precision, MI300A with partial-pass runs as fast
as MI300X with the default algorithm.
...
\begin{figure*}[h]  
    ...
    \captionsetup[sub]{singlelinecheck=off}
    \subfloat[$\mkern-90mu$]{\label{subfig:single_precision_speedup} \includegraphics[width=0.43\textwidth]{singlespeedup.pdf}}
    \subfloat[$\mkern-90mu$]{\label{subfig:double_precision_speedup} \includegraphics[width=0.43\textwidth]{doublespeedup.pdf}}
