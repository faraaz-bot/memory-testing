...
\begin{figure*}[h]  
  ...
  \subfloat[$\mkern-90mu$]{\label{subfig:double_precision_time} \includegraphics[width=0.45\textwidth]{doubletime.pdf}}
  \caption{Median execution time for single-precision (left) and double-precision (right).}
