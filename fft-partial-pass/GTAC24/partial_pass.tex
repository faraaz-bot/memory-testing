...
\renewcommand{\@maketitle}{%
    ...
    \begin{center}%
        ...
        \vskip2.5em{\large\lineskip.5em\begin{tabular}[t]{c}\@author\end{tabular}\par }%
    \end{center}%
    \par}
\makeatother
...
\begin{figure}[h]  
  ...
  \subfloat[$\mkern-90mu$]{\label{subfig:single_precision_time} \includegraphics[width=0.42\textwidth]{singletime.pdf}}\\
  \subfloat[$\mkern-90mu$]{\label{subfig:double_precision_time} \includegraphics[width=0.42\textwidth]{doubletime.pdf}}
  \caption{Median execution time per batch for single-precision (top) and double-precision (bottom).}
...
\begin{figure}[h]  
    ...
    \captionsetup[sub]{singlelinecheck=off}
    \subfloat[$\mkern-90mu$]{\label{subfig:single_precision_speedup} \includegraphics[width=0.42\textwidth]{singlespeedup.pdf}}\\
    \subfloat[$\mkern-90mu$]{\label{subfig:double_precision_speedup} \includegraphics[width=0.42\textwidth]{doublespeedup.pdf}}
    \caption{Speedup for single-precision (top) and double-precision (bottom).}
    \label{fig:speed_up}
  \end{figure}
