...
int main(int argc, char* argv[])
{
    ...
    if(my_rank == root_rank)
    {
        ...
        std::cout << proc_grid_intermediate[0] << "x" << proc_grid_intermediate[1] << "x"
                  << proc_grid_intermediate[2] << "  ";
        ...
        plan_validate = fftw_plan_dft_3d(N[2],
                                         N[1],
                                         N[0],
                                         (fftw_complex*)rocfft_output.data(),
                                         (fftw_complex*)rocfft_output.data(),
                                         FFTW_BACKWARD,
                                         FFTW_ESTIMATE);
